...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, required=False, default='test_symh_2', help='model id')
    ...
    parser.add_argument('--data_path', type=str, default='symh.csv', help='data file')
    parser.add_argument('--features', type=str, default='S',
                        help='forecasting task, options:[M, S, MS]; M:multivariate predict multivariate, S:univariate predict univariate, MS:multivariate predict univariate')
    parser.add_argument('--target', type=str, default='SYM', help='target feature in S or MS task')
    ...
    parser.add_argument('--moving_avg', type=int, default=10, help='window size of moving average')
